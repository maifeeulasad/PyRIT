...
def _validate_and_prepare_data(
    reliability_data: np.ndarray,  # type: ignore[ty:invalid-type-arguments]
    level_of_measurement: str,
    missing: float | None,
) -> tuple[np.ndarray, np.ndarray, np.ndarray]:  # type: ignore[ty:invalid-type-arguments]
    """
...
def _build_value_counts_matrix(
    data: np.ndarray,  # type: ignore[ty:invalid-type-arguments]
    valid_mask: np.ndarray,  # type: ignore[ty:invalid-type-arguments]
    categories: np.ndarray,  # type: ignore[ty:invalid-type-arguments]
) -> np.ndarray:  # type: ignore[ty:invalid-type-arguments]
    """
...
def _build_coincidence_matrix(
    value_counts: np.ndarray,  # type: ignore[ty:invalid-type-arguments]
) -> np.ndarray:  # type: ignore[ty:invalid-type-arguments]
    """
...
def _build_expected_matrix(
    coincidence_matrix: np.ndarray,  # type: ignore[ty:invalid-type-arguments]
) -> tuple[np.ndarray, np.ndarray, float]:  # type: ignore[ty:invalid-type-arguments]
    """
...
def _build_ordinal_distance_matrix(
    num_categories: int,
    n_v: np.ndarray,  # type: ignore[ty:invalid-type-arguments]
) -> np.ndarray:  # type: ignore[ty:invalid-type-arguments]
    """
...
def krippendorff_alpha(
    reliability_data: np.ndarray,  # type: ignore[ty:invalid-type-arguments]  # shape: (num_raters_or_trials, num_items); dtype float

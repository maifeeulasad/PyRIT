...
def main(*, args: Optional[list[str]] = None) -> int:
    ...
    sys.stdout.reconfigure(errors="replace")  # type: ignore[ty:possibly-missing-attribute]
    sys.stderr.reconfigure(errors="replace")  # type: ignore[ty:possibly-missing-attribute]
